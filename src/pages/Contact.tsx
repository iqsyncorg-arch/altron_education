                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-gray-400">Have questions about our courses, fees, or enrollment? Our team is ready to help.</p>
                        </div>

                        <div className="space-y-4">
                            {contactInfo.map((info, i) => (
                                <div key={i} className="flex items-start gap-4 glass rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all">
                                    ...
                                    <div>
                                        ...
                                        {info.href ? (
                                            <a href={info.href} className="text-white text-sm hover:text-brand-500 transition-colors">{info.value}</a>
                                        ) : (
                        ...
                        <div className="glass rounded-2xl p-6 border border-white/10">
                            ...
                            <div className="space-y-3">
                                <a href="https://wa.me/919962456533" className="flex items-center gap-3 text-sm text-gray-300 hover:text-green-400 transition-colors">
                                    <span className="text-2xl">💬</span> Chat on WhatsApp
                                </a>
                                <a href="tel:+919962456533" className="flex items-center gap-3 text-sm text-gray-300 hover:text-brand-500 transition-colors">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 text-sm focus:outline-none focus:border-brand-500 transition-colors"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full bg-brand-800 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-brand-500 transition-colors"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 text-sm focus:outline-none focus:border-brand-500 transition-colors resize-none"
                                        />
                                    </div>
